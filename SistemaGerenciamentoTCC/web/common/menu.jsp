<div class="menu">
    <ul id="nav">  
        ...
        <li>Alunos
            <ul> 
                <li><a href="../../SistemaGerenciamentoTCC/cadastrarAluno.jsp">Cadastrar</a></li> 
                <li><a href="AlunoListarServlet">Listar, Editar ou Desativar</a></li> 
            </ul> 
        </li>
        <li>Professores
            <ul> 
        ...
        <li>Propostas TCC
            <ul> 
                <li><a href="#">Enviar escolha do tema</a></li> 
